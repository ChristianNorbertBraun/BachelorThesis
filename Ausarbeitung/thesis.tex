...
\begin{itemize}
  \item \textbf{Eventual delivery:} Wenn eine Schreiboperation ein Datenreplika verändert, wird diese Schreiboperation irgendwann bei allen Datenreplikas durchgeführt.
