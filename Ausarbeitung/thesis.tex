...
curl -F "file=@Buchung" "http://localhost:8888/book/IBAN/BIC/Timestamp"

# Anfragen einer Datei über den Filer
curl "http://localhost:8888/book/IBAN/BIC/Timestamp"
{"Daten":1,"MehrDaten":2}

# Filtern aller Dateien in einem Ordner über den Dateinamen
curl "http://localhost:8888/book/IBAN/BIC/?lastFileName=Timestamp"
{
  "Path": "/BIC/IBAN/",
  "Files": [
    {
